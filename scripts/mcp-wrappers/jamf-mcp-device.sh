...
PROFILE="${1:-jamf}"          # matches the --profile used with `entra-device-auth login`
MCP_URL="${2:-https://jamf-mcp.colgate.edu/mcp}"
CALLBACK_PORT="${3:-3334}"      # unused by mcp-remote once --header bypasses OAuth, but it still binds this port
